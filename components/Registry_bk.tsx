...
type RegistryModalType = "honeymoon" | "monetary" | null;
...
interface RegistryOption {
  ...
  description: string;
  buttonLabel: string;
  type: Exclude<RegistryModalType, null>;
}
...
const registryOptions: RegistryOption[] = [
  {
    ...
    description:
      "Help us create beautiful memories as we begin our first adventure together as husband and wife.",
  ...
  },
  {
    ...
    title: "Monetary Gift",
    description:
      "For guests who would like to bless our new beginning with a monetary gift.",
    buttonLabel: "View Gift Options",
    type: "monetary",
  },
];

export default function Registry() {
  const [activeModal, setActiveModal] = useState<RegistryModalType>(null);
  ...
  function openModal(type: Exclude<RegistryModalType, null>) {
    setActiveModal(type);
  }
  ...
  const isHoneymoon = activeModal === "honeymoon";
      ...
      <div className="registry-container">
        ...
        >
          ...
          <p>
            ...
            further, we have provided a few meaningful options below.
          </p>
        </motion.header>
        ...
        <div className="registry-grid">
          {registryOptions.map((option, index) => {
            ...
            return (
              ...
              >
                <div className="registry-card-number">
          ...
          >
            ...
            >
              <button
                ...
                onClick={closeModal}
                aria-label="Close registry options"
              >
                <X size={21} />
              </button>
              ...
              <div className="registry-modal-heading">
                <span className="section-tag">
                  {isHoneymoon ? "Honeymoon Fund" : "Monetary Gift"}
                </span>
                ...
                <p>
                  {isHoneymoon
                    ? "As we begin this new chapter together, your generosity can help us create beautiful memories on our honeymoon."
                    : "Whether through a prayer, a kind word or a financial gift, every expression of love means so much to us."}
                </p>
              </div>
              ...
              {isHoneymoon && (
                ...
                >
                  <div className="honeymoon-experience-card">
                    <span>01</span>
                    <h3>Our Journey</h3>
                  ...
                  <div className="honeymoon-experience-card">
                    ...
                    <p>
                      Contribute toward an excursion or memorable experience.
                    </p>
                  </div>
              ...
              <div className="registry-payment-section">
                <div className="registry-payment-header">
                  <Sparkles size={18} strokeWidth={1.4} />

                  <h3>Ways to Bless Our New Beginning</h3>

                  <p>
                    Your love, prayers and generosity mean so much to us. You
                    may use any of the options below.
                  </p>
                </div>
                ...
                <div className="registry-payment-grid">
                  ...
                  <div className="registry-payment-card">
                    ...
                    <CopyButton
                      ...
                      ariaLabel="Copy Mobile Money number"
                    />
                  </div>
