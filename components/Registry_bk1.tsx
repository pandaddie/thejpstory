          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="honeymoon-experience-card honeymoon-monetary-card">
                  <div className="honeymoon-card-header">
              ...
              <div className="registry-payment-section">
                ...
                <div className="registry-payment-group">
                  <div className="registry-payment-group-heading">
                    <span>01</span>

                    <div>
                      <h4>United States &amp; Canada</h4>
                      <p>
                        Contribution methods available for guests in North
                        America.
                      </p>
                    </div>
                  </div>
                ...
                <div className="registry-payment-group">
                  <div className="registry-payment-group-heading">
                    ...
                    <div>
                      ...
                      <p>
                        Contribution methods available for guests outside North
                        America.
                      </p>
                    </div>
                  </div>
